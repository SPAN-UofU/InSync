 ...
 * Monitor prompt
 */
#define CONFIG_SYS_PROMPT		"A2F-SDR> "
...
#define CONFIG_HOSTNAME			A2F-SDR
#define CONFIG_BOOTARGS			"a2f_platform=a2f-sdr "\
...
#define CONFIG_EXTRA_ENV_SETTINGS				\
	...
	"ipaddr=141.212.110.232\0"					\
	"serverip=141.212.106.51\0"					\
	"image=developer.uImage\0"					\
	"u-boot_image=u-boot.bin\0"					\
	"update=tftp ${image};prot off ${flashaddr} +${filesize};era ${flashaddr} +${filesize};cp.b ${loadaddr} ${flashaddr} ${filesize};\0"	\
	"u-boot_update=tftp ${u-boot_image}; cptf 0x0 ${loadaddr} ${filesize} 1;\0" \
